...
{
public:
	MeanFilterByTwo1DKernels(byte size) :MeanFilterByTwo1DKernels(size, size) {};
...
public:
	...
	void (MeanFilterByTwo1DKernels::*fun)(  ushort*, ushort*) = &MeanFilterByTwo1DKernels::FilterBlock;
private:
